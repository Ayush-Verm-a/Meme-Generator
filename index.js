function clearAll(){
    ...
    meme.replaceChildren();
    joke.replaceChildren();
...
function showJoke(){
  ...
  jokecontent=document.getElementById("joke");
...
function showRiddle() {
  ...
  riddleanswer.setAttribute('id','riddleAnswer');
  riddlequestion.textContent="Riddle: "+randomRiddle.question;
  riddleanswer.textContent="Answer: "+randomRiddle.answer;
  riddleanswer.hidden=true;
  const riddlecontent=document.getElementById("riddle");
  riddlecontent.appendChild(riddlequestion);
  riddlecontent.appendChild(riddleanswer);
}

function revealAnswer(){
  const riddlecontent=document.getElementById("riddle");
  const riddlequestion=riddlecontent.querySelector('p');
  const riddleanswer=document.querySelector("#riddleAnswer");
  if(riddlequestion){
    if(riddleanswer.hidden){
      riddleanswer.hidden=false;
    }
    else{
      alert("Answer is already reavealed!");
    }
  }
  else{
